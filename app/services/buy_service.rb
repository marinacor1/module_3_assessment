class BuyService
  ...
  def get_close_stores(zip)
    @connection.get "https://api.bestbuy.com/v1/stores(area(#{zip},25))?format=json&show=storeId,phone,city,storeType,longName,distance&pageSize=25&apiKey=#{ENV['bb_key']}"
  end
